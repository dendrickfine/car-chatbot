...
# Lexicon (tambahkan 'miliar' ke dalam budget)
lexicon = {
    ...
    'budget': ['budget', 'harga', 'jtan', 'jt', 'juta', 'miliar'],  # Tambahkan 'miliar'
    'fuel': {
...
def generate_recommendation(parsed_query):
    ...
    if filtered_cars.empty:
        ...
        if parsed_query['budget'] and parsed_query['budget'] < 150_000_000:
            suggestions.append("meningkatkan budget di atas 20 juta")
        if parsed_query['fuel_type']:
